...
{
    const SANDBOX_IDENTITY_BASE_URL = 'https://preprod-api.myinvois.hasil.gov.my/connect/token';
    const PROD_IDENTITY_BASE_URL = 'https://api.myinvois.hasil.gov.my/connect/token';
